...
export const ImageDisplay =({navigation}) => {
      ...
      <View style={{height:"100%",width:"100%"}}>
          <ImageBackground
            ...
            <View style={{height:"100%",width:"100%",alignItems:"center",paddingTop:StatusBar.currentHeight}}>
              ...
              <Animated.View style={{...styles.SearchBox_Main_Style,transform: [{translateX:x}]}}>
              <TextInput 
              ...
              />
                <TouchableOpacity style={{height:"80%",width:"15%",justifyContent:"center",alignItems:"center"}} 
                  onPress={()=>navigation.navigate("FullCatogery",{ "query" : searchQuery })}>
