...
//   const selectedIndex = 1;
  ...
  const [searchQuery, setSelectedIndex] = useState('');
  ...
  const categories = [
    ...
    },
    {
      title: 'Animals',
      img_url:
        'https://images.pexels.com/photos/2071873/pexels-photo-2071873.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940',
    },
    ...
    },
    {
      title: 'Games',
      img_url:
        'https://images.pexels.com/photos/159393/gamepad-video-game-controller-game-controller-controller-159393.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500',
    },
    ...
    },
    {
      title: 'Jungle',
      img_url:
        'https://images.pexels.com/photos/1583207/pexels-photo-1583207.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500',
    },
    {
      title: 'Sports',
      img_url:
    ...
    },
    {
      title: 'Space',
      img_url:
        'https://images.pexels.com/photos/5439/earth-space.jpg?auto=compress&cs=tinysrgb&dpr=1&w=500',
    },
    {
      title: 'Technology',
      img_url:
    ...
    },
    {
      title: 'Places',
      img_url:
        'https://images.pexels.com/photos/1462935/pexels-photo-1462935.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500',
    },
    {
      title: 'Abstract',
      img_url:
  ...
  const renderItemCatogories = ({item, index}) => {
    return (
      <TouchableOpacity
        style={{
          height: '90%',
        ...
        onPress={() =>
          navigation.navigate('FullCatogery', {query: item.title})
        }>
        <ImageBackground
      ...
      <View style={{height: '100%', width: '100%'}}>
          ...
          <View
            ...
            <Animated.View
              ...
              <TextInput
                ...
                value={searchQuery}
                onChangeText={value => setSelectedIndex(value)}
              />
              <TouchableOpacity
                style={{
                  height: '80%',
                ...
                onPress={() =>
                  navigation.navigate('FullCatogery', {query: searchQuery})
                }>
        ...
        <View
          ...
          <FlatList
            ...
            renderItem={renderItemCatogories}
            horizontal={true}
